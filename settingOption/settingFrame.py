...
class SettingFrame (Frame):
    ...
    def _fullscreenSwitcher (self) -> None:
        ...
        switcher = Switch(self, "", ..., self.switch_value)
        switcher.grid(row = 1, column = 1, sticky = ctk.E, padx = (0, self.side_pad))
    ...
    def _plansOverview (self) -> None:
        ...
        plan_button.grid(row = 3, column = 1, sticky = ctk.E, padx = (0, self.side_pad))
    ...
    def _sportSelection (self) -> None:
        ...
        sport_selection.grid(row = 5, column = 1, rowspan = 2, sticky = ctk.E, padx = (0, self.side_pad), pady = self.bottom_pad)
    ...
    def _rowsInOverview (self) -> None:
        ...
        rows_entry.grid(row = 7, column = 1, sticky = ctk.E, padx = (0, self.side_pad))
