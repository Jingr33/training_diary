...
class SportChart (BarChart):
    ...
    #     self.range_cb = ComboBox(self, chart_range_option, self._chartTrigger, self.var_option)
    ...
    # def _chartTrigger (self, value) -> None:
